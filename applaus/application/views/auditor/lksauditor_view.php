<?php $this->load->view('auditor/_partials/header.php') ?>

<body>
    <?php $this->load->view('auditor/_partials/sidebar.php') ?>
        ...
        <section class="content">
            ...
            <table id="tblksauditor" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td ><a onclick="return confirm('Anda Yakin Ingin Hapus?')" href="<?php echo base_url('auditor/lksauditor/hapus_data/'.$lks->id)?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                    <a href="<?php echo base_url('auditor/lksauditor/edit_data/'.$lks->id)?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> </td>
                </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" enctype='multipart/form-data' action="<?php echo base_url().'auditor/lksauditor/simpanlks' ?>">
...
<?php $this->load->view('auditor/_partials/footer.php') ?>
