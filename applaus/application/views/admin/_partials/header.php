...
<head>
  ...
  <title>APPLAUSE | Dashboard</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="#" class="logo">
        ...
        <span class="logo-mini"><b>SMB</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><img src="<?php echo base_url() ?>assets/img/logosmb.png" alt="Logo Image"></span>
      </a>
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url() ?>assets/img/noavatar.png" class="user-image" alt="User Image">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-header">
                  ...
                  <p>
                    ...
                    <small><?php echo $this->session->userdata('ses_id'); ?></small>
                  </p>
                </li>
                <!-- Menu Body -->
                <li class="user-body">
