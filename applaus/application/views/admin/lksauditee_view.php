        ...
        <section class="content">
            ...
            <table id="tblksauditor" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    ...
                    <td ><a onclick="return confirm('Anda Yakin Ingin Hapus?')" href="<?php echo base_url('admin/lksauditee/hapus_data/'.$lks->id)?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                    <a href="<?php echo base_url('admin/lksauditee/edit_data/'.$lks->id)?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a> </td>
                </tr>
